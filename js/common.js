var com = function() {
    ...
    com.writejs = function(path) {
        document.write(unescape("%3Cscript src='" + path + "?t=" + (new Date().getTime()) + "' type='text/javascript'%3E%3C/script%3E"));
    }
    ...
    com.validate = function(type, value) {
        ...
        if (type == "phone") {
            ...
            return /^0?(13[0-9]|15[012356789]|17[0678]|18[0-9]|14[57])[0-9]{8}$/.test(val)
        }
    }

    com.initPullRefresh = function() {
